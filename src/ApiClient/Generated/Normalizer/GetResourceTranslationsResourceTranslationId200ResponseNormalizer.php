...
class GetResourceTranslationsResourceTranslationId200ResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return GetResourceTranslationsResourceTranslationId200Response::class === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && GetResourceTranslationsResourceTranslationId200Response::class === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new GetResourceTranslationsResourceTranslationId200Response();
