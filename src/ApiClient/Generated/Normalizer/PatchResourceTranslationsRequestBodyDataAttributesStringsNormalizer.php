...
class PatchResourceTranslationsRequestBodyDataAttributesStringsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return PatchResourceTranslationsRequestBodyDataAttributesStrings::class === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && PatchResourceTranslationsRequestBodyDataAttributesStrings::class === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new PatchResourceTranslationsRequestBodyDataAttributesStrings();
    ...
    {
        return [PatchResourceTranslationsRequestBodyDataAttributesStrings::class => false];
    }
}
