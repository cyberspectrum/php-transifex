...
class PostResourcesRequestBodyDataAttributesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return PostResourcesRequestBodyDataAttributes::class === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && PostResourcesRequestBodyDataAttributes::class === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new PostResourcesRequestBodyDataAttributes();
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if ($object->isInitialized('i18nOptions') && null !== $object->getI18nOptions()) {
    ...
    {
        return [PostResourcesRequestBodyDataAttributes::class => false];
    }
}
