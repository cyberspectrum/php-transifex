...
class ResourceTranslationsResponseDataAttributesStringsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return ResourceTranslationsResponseDataAttributesStrings::class === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && ResourceTranslationsResponseDataAttributesStrings::class === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new ResourceTranslationsResponseDataAttributesStrings();
