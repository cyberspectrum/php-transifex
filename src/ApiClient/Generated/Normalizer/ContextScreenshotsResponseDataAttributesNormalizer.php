...
class ContextScreenshotsResponseDataAttributesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return ContextScreenshotsResponseDataAttributes::class === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && ContextScreenshotsResponseDataAttributes::class === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new ContextScreenshotsResponseDataAttributes();
        ...
        if (array_key_exists('media_url', $data)) {
            $object->setMediaUrl($data['media_url']);
        }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getMediaUrl()) {
            $data['media_url'] = $object->getMediaUrl();
        }
