...
class PatchResourceStringCommentsCommentId200ResponseDataItemattributesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return PatchResourceStringCommentsCommentId200ResponseDataItemattributes::class === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && PatchResourceStringCommentsCommentId200ResponseDataItemattributes::class === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new PatchResourceStringCommentsCommentId200ResponseDataItemattributes();
