...
class GetResourceStringComments200ResponseDataItemattributesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return GetResourceStringComments200ResponseDataItemattributes::class === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && GetResourceStringComments200ResponseDataItemattributes::class === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new GetResourceStringComments200ResponseDataItemattributes();
    ...
    {
        return [GetResourceStringComments200ResponseDataItemattributes::class => false];
    }
}
