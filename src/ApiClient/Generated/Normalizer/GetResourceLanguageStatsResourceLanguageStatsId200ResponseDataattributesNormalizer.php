...
class GetResourceLanguageStatsResourceLanguageStatsId200ResponseDataattributesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return GetResourceLanguageStatsResourceLanguageStatsId200ResponseDataattributes::class === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && GetResourceLanguageStatsResourceLanguageStatsId200ResponseDataattributes::class === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new GetResourceLanguageStatsResourceLanguageStatsId200ResponseDataattributes();
