...
class PostResourceTranslationsAsyncUploadsMultipartFormDataRequestBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return PostResourceTranslationsAsyncUploadsMultipartFormDataRequestBody::class === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && PostResourceTranslationsAsyncUploadsMultipartFormDataRequestBody::class === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new PostResourceTranslationsAsyncUploadsMultipartFormDataRequestBody();
    ...
    {
        return [PostResourceTranslationsAsyncUploadsMultipartFormDataRequestBody::class => false];
    }
}
