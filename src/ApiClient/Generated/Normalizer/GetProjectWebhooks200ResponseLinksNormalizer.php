...
class GetProjectWebhooks200ResponseLinksNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return GetProjectWebhooks200ResponseLinks::class === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && GetProjectWebhooks200ResponseLinks::class === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new GetProjectWebhooks200ResponseLinks();
    ...
    {
        return [GetProjectWebhooks200ResponseLinks::class => false];
    }
}
