...
class ResourceStringsAsyncUploadsResponseDataAttributesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return ResourceStringsAsyncUploadsResponseDataAttributes::class === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && ResourceStringsAsyncUploadsResponseDataAttributes::class === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new ResourceStringsAsyncUploadsResponseDataAttributes();
        ...
        if (array_key_exists('details', $data) && null !== $data['details']) {
            $object->setDetails($this->denormalizer->denormalize($data['details'], ResourceStringsAsyncUploadsResponseDataAttributesDetails::class, 'json', $context));
