...
class ResourcesResponseAttributes
{
    /**
    ...
    /**
     * Any options that determine how the resource will be parsed and compiled.
     *
     * @var ResourcesAttributesI18nOptions|null
     */
    protected $i18nOptions;
    /**
     * File format type version.
     *
     * @var float
     */
    protected $i18nVersion;
    /**
    ...
    protected $slug;
    /**
     * Number of strings in the resource content.
     *
     * @var float
     */
    ...
    protected $webmUrl;
    /**
     * Number of words in the resource content.
     *
     * @var float
     */
    protected $wordCount;
     ...
     * Any options that determine how the resource will be parsed and compiled.
     */
    public function getI18nOptions(): ?ResourcesAttributesI18nOptions
    {
     ...
     * Any options that determine how the resource will be parsed and compiled.
     */
    public function setI18nOptions(?ResourcesAttributesI18nOptions $i18nOptions): self
    {
        $this->initialized['i18nOptions'] = true;
     ...
     * File format type version.
     */
    public function setI18nVersion(float $i18nVersion): self
    {
        $this->initialized['i18nVersion'] = true;
     ...
     * Number of strings in the resource content.
     */
    public function setStringCount(float $stringCount): self
    {
        $this->initialized['stringCount'] = true;
    ...
    {
        $this->initialized['wordCount'] = true;
