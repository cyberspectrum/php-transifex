...
class GetOrganizationActivityReportsAsyncDownloadByOrganizationActivityReportsAsyncDownloadIdInternalServerErrorException extends InternalServerErrorException
{
    /**
