 ...
 */
final class MessageLogger implements Plugin
{
    /**
     ...
     * @var string
     */
    public const APACHE_COMMON_LOG = '{hostname} {req_header_User-Agent} - ' .
    '[{date_common_log}] "{method} {target} HTTP/{version}" {code} {res_header_Content-Length}';
    public const SHORT_LOG = '[{ts}] "{method} {target} HTTP/{version}" {code}';
    ...
    public function __construct(
        ...
        private readonly string $template = self::APACHE_COMMON_LOG
    ) {
    }
    ...
    public function handleRequest(RequestInterface $request, callable $next, callable $first): Promise
    {
        ...
        return $promise->then(function (ResponseInterface $response) use ($request) {
            $message = $this->format($request, $response);
